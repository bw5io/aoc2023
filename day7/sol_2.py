...
def check_card_type(card):
    ...
    card_count_values[-1]+=joker_count
    card_count_occurence = dict(Counter(card_count_values))
...
def sort_card_on_hand(card_on_hand):
    ...
    return sort_card_on_hand(left)+[middle]+sort_card_on_hand(right)
